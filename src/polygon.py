...
#all the attributes created are basically pymunk syntax. Refer documentation for better understanding
#these creates shapes with desired physical properties. The draw function displays wood blocks on screen using blit.
class Polygon():
